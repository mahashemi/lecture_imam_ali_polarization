...
\begin{frame}{The Narrow Self vs.\ the Expanded Self}
...
\hline
& \textbf{Narrow Self (self-love)} & \textbf{Expanded Self (via love)} \\
\hline
Boundary of ``me'' & Just this body, this interest & Every other human being -- ideally all creation \\
\hline
Typical traits & Timid, avaricious, quick-tempered, arrogant & Vitality, warmth, real connection \\
\hline
Self-regard & Not erased -- but walled in & Not erased -- but no longer walled in \\
\hline
Mutahhari's words & ``a limitation and a defensive barrier'' & ``perfecting and adding to him'' \\
\hline
\end{tabular}
...
\large
\[
\boxed{\text{Reform} = \text{Expansion, not Reduction}}
\]
